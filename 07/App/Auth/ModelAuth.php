...
class ModelAuth extends BaseModel
{
    ...
    public function __construct()
    {
        ...
        $this->hasOne("user_roles", "id", "user_id");
        $this->hasMany("App\Auth\ModelRoles", "role_id", "id");

        $this->hasOne("role_permissions","id","role_id");
        $this->hasMany("App\Auth\ModelPermissions", "permissions_id", "id");

        $this->role = $this->SelectWhat([
    ...
    public function userRole(){
        ...
        $ret = $this->role
                ->WhereEqually("email", $_SESSION['email'])
                ->Get();
        $row = $ret->fetch_assoc();
